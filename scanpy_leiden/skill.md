...
context_params:
- protocol
success_thresholds: n_clusters >= 3 and n_clusters <= 200
---
...
Leiden clustering partitions single cells into groups based on transcriptional similarity using community detection on a k-nearest neighbor graph.
...
More neighbors create smoother, larger clusters.
...
- **Causal chain**: Higher resolution lowers the similarity threshold for cluster formation

#### too_many_clusters

- **Adjust**: decrease resolution by 0.2-0.5
- **Causal chain**: Lower resolution raises the similarity threshold, merging clusters
